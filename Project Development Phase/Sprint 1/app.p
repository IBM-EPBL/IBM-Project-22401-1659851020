...
try:
    conn=ibm_db.connect("jdbc:db2://b1bc1829-6f45-4cd4-bef4-10cf081900bf.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud:32304/bludb:user=rqj83021;password=WHA8kjeDIcLx6jxd;sslConnection=true;", "", "")
    print("Db connected")
except:
    print("Error")
